-- Migratsiya 001: dobavlyayem autentifikatsiyu
-- Vypolny po odnomu zaprosu v D1 Console (https://dash.cloudflare.com/?to=/:account/workers/d1)
-- Yesli D1 Console rugayetsya na multi-statement, vstavlay po odnomu CREATE/ALTER.
