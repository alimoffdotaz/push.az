...
const DICT = {
  ru: {
    ...
    'namaz.title': 'Намаз',
    'namaz.hint': 'Время по расчёту джафари (Кум). Напоминание придёт веб-пушем и в Telegram, если бот привязан.',
    'namaz.enable': 'Напоминать о намазах',
    'namaz.geo': 'Определить геопозицию',
    'namaz.loc_none': 'Место не задано — нажми кнопку выше.',
    'namaz.loc': '{city} ({lat}, {lng})',
    'namaz.prayers_aria': 'Намазы',
    'namaz.prayer.fajr': 'Фаджр',
    'namaz.prayer.dhuhr': 'Зухр',
    'namaz.prayer.asr': 'Аср',
    'namaz.prayer.maghrib': 'Магриб',
    'namaz.prayer.isha': 'Иша',
    'namaz.prayer.midnight': 'Полночь',
    'namaz.lead': 'За сколько минут до намаза слать пуш',
    'namaz.lead_at': 'В момент намаза',
    'namaz.lead_n': 'за {n} мин',
    'namaz.fajr_pre1h': 'Ещё пуш за час до утреннего намаза (фаджр)',
    'namaz.today': 'Сегодня: {times}',
  ...
  az: {
    ...
    'namaz.title': 'Namaz',
    'namaz.hint': 'Vaxt Cəfəri (Qum) hesabı ilə. Bildiriş web push və Telegram-a (bot bağlıdırsa) gələcək.',
    'namaz.enable': 'Namaz vaxtlarını xatırlat',
    'namaz.geo': 'Mövqeyi təyin et',
    'namaz.loc_none': 'Yer yoxdur — yuxarıdakı düyməyə bas.',
    'namaz.loc': '{city} ({lat}, {lng})',
    'namaz.prayers_aria': 'Namazlar',
    'namaz.prayer.fajr': 'Fəcr',
    'namaz.prayer.dhuhr': 'Zöhr',
    'namaz.prayer.asr': 'Əsr',
    'namaz.prayer.maghrib': 'Məğrib',
    'namaz.prayer.isha': 'İşa',
    'namaz.prayer.midnight': 'Geceyarı',
    'namaz.lead': 'Namaza neçə dəqiqə qalmış göndərmək',
    'namaz.lead_at': 'Namaza tam vaxtda',
    'namaz.lead_n': '{n} dəq qalmış',
    'namaz.fajr_pre1h': 'Səhər namazına (fəcr) bir saat qalmış da bildiriş',
    'namaz.today': 'Bu gün: {times}',
  ...
  en: {
    ...
    'namaz.title': 'Prayer times',
    'namaz.hint': 'Times use the Ja\'fari (Qum) calculation. Alerts go to web push and Telegram if the bot is linked.',
    'namaz.enable': 'Remind me of prayer times',
    'namaz.geo': 'Use my location',
    'namaz.loc_none': 'No place yet — tap the button above.',
    'namaz.loc': '{city} ({lat}, {lng})',
    'namaz.prayers_aria': 'Prayers',
    'namaz.prayer.fajr': 'Fajr',
    'namaz.prayer.dhuhr': 'Dhuhr',
    'namaz.prayer.asr': 'Asr',
    'namaz.prayer.maghrib': 'Maghrib',
    'namaz.prayer.isha': 'Isha',
    'namaz.prayer.midnight': 'Midnight',
    'namaz.lead': 'How many minutes before prayer to notify',
    'namaz.lead_at': 'At prayer time',
    'namaz.lead_n': '{n} min before',
    'namaz.fajr_pre1h': 'Also notify one hour before Fajr',
    'namaz.today': 'Today: {times}',
