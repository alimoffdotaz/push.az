...
const DICT = {
  ru: {
    ...
    // Test push body
    'test.body': 'Тестовое уведомление. Всё работает!',
    'test.default_body': 'Пора!',
    'test.notification_title': 'push.az',
    'test.notification_default_body': 'Уведомление',
  ...
  az: {
    ...
    'takeover.test_title': 'Challenge testi',
    'takeover.test_note': 'Bağlamaq üçün düzgün rəqəmə bas.',

    'settings.title': 'Parametrlər',
    'settings.worker_url': 'Cloudflare Worker URL',
    'settings.worker_hint': 'URL olmadan tətbiq lokal işləyir — push yalnız app açıq olanda gələcək.',
    'settings.lang': 'Dil',
    'settings.test_badge': 'Badge testi',
    'settings.clear_badge': 'Badge sıfırla',
    'settings.test_challenge': 'Challenge testi',
    ...
    'toast.badge_unsupported': 'Badge API bu cihazda dəstəklənmir',
    'toast.badge_set': 'Badge = 3 — home screen-dəki ikona bax',
    'toast.badge_cleared': 'Badge sıfırlandı',
    ...
    'test.body': 'Test bildiriş. Hər şey işləyir!',
    'test.default_body': 'Vaxtıdır!',
    'test.notification_title': 'push.az',
    'test.notification_default_body': 'Bildiriş',
  ...
  en: {
    ...
    'takeover.test_title': 'Test challenge',
    'takeover.test_note': 'Tap the correct digit to dismiss.',

    'settings.title': 'Settings',
    'settings.worker_url': 'Cloudflare Worker URL',
    'settings.worker_hint': 'Without a URL the app works locally — push only arrives while the app is open.',
    'settings.lang': 'Language',
    'settings.test_badge': 'Test badge',
    'settings.clear_badge': 'Clear badge',
    'settings.test_challenge': 'Test challenge',
    ...
    'toast.badge_unsupported': 'Badge API not supported on this device',
    'toast.badge_set': 'Badge = 3 — check the icon on home screen',
    'toast.badge_cleared': 'Badge cleared',
    ...
    'test.body': 'Test notification. Everything works!',
    'test.default_body': 'Time!',
    'test.notification_title': 'push.az',
    'test.notification_default_body': 'Notification',
